...
public class BigDecimalEx {
    public static void main(String[] args) {
        ...
        System.out.print("bd3 = " + bd3.unscaledValue());
        System.out.print(", \tvalue = " + bd3.scale());
        System.out.print(", \tprecision = " + bd3.precision());
        System.out.println();

        System.out.println(bd1.divide(bd2, 2, HALF_UP)); // 123.45
        System.out.println(bd1.setScale(2, HALF_UP)); // 123.45
        System.out.println(bd1.divide(bd2, new MathContext(2, HALF_UP))); // 123.45
    }
}
