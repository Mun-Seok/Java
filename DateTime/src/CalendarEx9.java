// 날짜 계산을 위한 몇 가지 메서드를 구현해본 예제
public class CalendarEx9 {
    public static void main(String[] args) {
        System.out.println("2022. 5. 31 : " + getDayOfWeek(2022, 5, 31));
        System.out.println("2020. 6. 1 : " + getDayOfWeek(2020, 6, 1));
...
/*
    ...
    String convertDayToDate(int day) : 일단위로 값을 년월일의 형태의 문자열로 변환하여 반환한다.
